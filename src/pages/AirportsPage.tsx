...
export function AirportsPage() {
  ...
  const xfly = useQuery({ queryKey: ["xfly-airport", selected.icao], queryFn: () => getXflyAirportData(selected.icao), enabled: selected.icao.length === 4, retry: 1, staleTime: 10 * 60_000 });
