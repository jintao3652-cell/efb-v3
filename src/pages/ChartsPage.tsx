  ...
  return <div className="chart-page split-page">
    <section className="panel chart-sidebar">
      ...
      {source === "local" ? <>
        ...
        <p className="source-description">选择包含 <code>Terminals/&lt;ICAO&gt;/</code> 的文件夹，或含相同目录结构的 ZIP 压缩包。</p>
